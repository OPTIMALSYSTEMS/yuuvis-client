...
import { PluginExtensionConfig } from '@yuuvis/framework';
...
export class PluginSearchComponent {
  ...
  init(extension: PluginExtensionConfig, parent: any) : Selectable | SelectableGroup {
    ...
    this.parent = parent;
    return (this.selectable = !this.inputs.init ? this.toSelectable() :
      this.pluginService.applyFunction(this.inputs.init, 'component, parent, SearchFilterGroup, SearchFilter', [this, this.parent, SearchFilterGroup, SearchFilter]));
  }
